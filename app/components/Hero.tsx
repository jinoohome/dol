    ...
    <section className="relative">
      ...
      <div className="container mt-8 space-y-4 text-center">
        <div className="space-y-2">
          <p className="text-sm text-muted font-medium tracking-wide">첫돌에 초대합니다</p>
          <h1 className="text-4xl font-bold gradient-text" style={{ fontFamily: "InkLipquid, serif" }}>
            {name}
          </h1>
          <div className="w-16 h-1 bg-gradient-to-r from-brand via-point to-sub rounded-full mx-auto"></div>
        </div>
        {showDday ? (
          <div className="mt-6 flex justify-center">
            <div className="card px-6 py-4 shadow-soft">
